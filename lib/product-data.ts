import { colors, tProduct, tProductId } from "./types";
...
export const productData: tProduct[] = [
  ...
  },
  {
    ...
    primaryImageUrlColor: "blue",
    promoImageUrl: "assets/gallery/vertigo/vertigo-promo-2.webp",
  ...
  },
  {
    ...
    byline:
      "The top of the drawer. Everyday essentials redefined. Part of the Staples collection.",
    primaryImageUrlColor: "black",
    promoImageUrl: "assets/gallery/staples/staples-tee-promo-2.webp",
    blackImageUrl: "assets/gallery/staples/staples-tee-black.webp",
    whiteImageUrl: "assets/gallery/staples/staples-tee-white.webp",
  ...
  },
  {
    ...
    pinkImageUrl: "assets/gallery/playtime/playtime-shoe-pink.webp",
  ...
  },
  {
    ...
    description:
      "A watch that keeps tabs with your active lifestyle. Can pair with any mobile device.  Free access to the app. Location, vitals, and fitness tracking all in one sleek design. Water resistant up to 50 meters. Long-lasting battery life for extended use. Customizable watch faces to match your style. Compatible with popular fitness apps for seamless integration.",
    byline:
...
const allProductIds = new Set(productData.map((product) => product.id));

export const productsById: Partial<Record<tProductId, tProduct>> =
  Object.fromEntries(productData.map((product) => [product.id, product]));
